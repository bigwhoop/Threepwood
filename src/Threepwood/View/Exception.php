 ...
 * @version    $Id: Exception.php 72 2009-09-24 18:51:27Z phil $
 */

namespace Threepwood\View;

/**
 * This exception can be thrown is something wrong related
 * to the view handling.
 * 
 * @category   Threepwood
 * @package    MVC
 * @subpackage View
